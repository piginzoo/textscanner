...
class GeometryBranch(Layer):
    ...
    def build(self, input_shape):
        ...
        self.dconv_order_seg1 = Conv2DTranspose(filters=1, kernel_size=(3, 3), strides=2, name="dconv_order_seg1",
                                                padding="same")  # 1/4
        ...
        self.conv_loc_map1 = Convolution2D(filters=self.filter_num, kernel_size=(3, 3), padding="same",
                                           name="conv_loc_map1")
        self.conv_loc_map2 = Convolution2D(filters=self.sequence_length, kernel_size=(1, 1), padding="same",
                                           name="conv_loc_map2")
    ...
    def call(self, inputs, training=None):
        ...
        h = s * q  # TODO 这个写法我用np.array测试了一下，没问题
